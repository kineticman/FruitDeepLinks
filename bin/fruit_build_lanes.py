...
PLACEHOLDER_BLOCK_MINUTES = _get_int_env(["FRUIT_PLACEHOLDER_BLOCK_MINUTES", "PEACOCK_PLACEHOLDER_BLOCK_MINUTES"], 60)
PLACEHOLDER_EXTRA_DAYS = _get_int_env(["FRUIT_PLACEHOLDER_EXTRA_DAYS", "PEACOCK_PLACEHOLDER_EXTRA_DAYS"], 5)
LANE_START_CH_DEFAULT = _get_int_env(["FRUIT_LANE_START_CH", "PEACOCK_LANE_START_CH"], 9000)
